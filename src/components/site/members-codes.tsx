      ...
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-10">
          <h1 className="font-heading text-4xl text-[var(--green-dark)]">
            {pick(lang, "Members Area", "Ardal Aelodau")}
          </h1>
          <div className="leaf-divider mx-auto mt-3" aria-hidden />
          <p className="text-muted-foreground">
            {pick(
              lang,
              "These codes are for members only — please do not share them with non-members.",
              "Mae'r codau hyn ar gyfer aelodau yn unig — peidiwch â'u rhannu â phobl nad ydynt yn aelodau.",
            )}
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          ...
          <Card className="rounded-[10px_26px_10px_26px] p-8 text-center">
            ...
            <h2 className="font-heading text-xl text-[var(--green-dark)]">
              {pick(lang, "Allotment Gate", "Giât y Rhandir")}
            </h2>
            <p className="font-mono text-4xl font-bold tracking-[0.2em] text-[var(--green-mid)]">
              {codes.allotment}
            </p>
            <p className="text-xs text-muted-foreground">
              {pick(lang, "Summer use only — for loading & unloading", "Defnydd haf yn unig — llwytho a dadlwytho")}
            </p>
          </Card>
        </div>
        ...
        <div className="flex items-start gap-2 rounded-xl bg-[var(--status-reserved-bg)] border border-[var(--status-reserved-line)] p-4 mt-6 text-sm text-[#8a5a10]">
          ...
          <span>
            {pick(
              lang,
              "Park in the National Trust car park on the left-hand side (summer only). Keep the gate closed and locked.",
              "Parciwch ym maes parcio'r Ymddiriedolaeth Genedlaethol ar yr ochr chwith (haf yn unig). Cadwch y giât ar gau ac ar glo.",
            )}
          </span>
        </div>
